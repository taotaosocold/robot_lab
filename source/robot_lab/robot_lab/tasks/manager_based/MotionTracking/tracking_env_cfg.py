...
import robot_lab.tasks.manager_based.MotionTracking.mdp as mdp
...
class ObservationsCfg:
    ...
    class PolicyProprioHistoryCfg(ObsGroup):
        ...
        # projected_gravity = ObsTerm(func=mdp.my_projected_gravity, noise=Unoise(n_min=-0.05, n_max=0.05))
