...
CASBOT_02_25DOF_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        fix_base=False,
        merge_fixed_joints=True,
        replace_cylinders_with_capsules=False,
        asset_path=f"{ISAACLAB_ASSETS_DATA_DIR}/Robots/casbot/02_description/urdf/CASBOT02_ENCOS_5dof_shell_20250801_no_hand.urdf",
...
for _a in CASBOT_02_25DOF_CFG.actuators.values():
